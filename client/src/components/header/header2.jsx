  ...
  function showOptions() {
    if (Auth.loggedIn()) {
      return (
        ...
        // </ul>
        <>
          <Link style={{ color: "#da0404", textDecoration: "none" }} to="/Browse">
            Browse our furniture
          </Link>
          <Link style={{ color: "#da0404", textDecoration: "none" }} to="/About">
            About us
          </Link>
          <Link style={{ color: "#da0404", textDecoration: "none" }} to="/Contact">
            Contact
          </Link>
        </>
      );
